...
def test_contact_empty(app):
    ...
    app.contact.add(
        Contact(firstname="", middlename="", lastname="", nickname="", title="", company="", address="",
                TelephoneHome="",
                TelephoneMobile="", TelephoneWork="", TelephoneFax="", email="", email2="", email3="", homepage="",
                byear="", ayear="",
...
def test_contact(app):
    ...
    app.contact.add(
        Contact(firstname="Yura", middlename="middlename", lastname="Goroshkin", nickname="nickname", title="Title",
                company="Company", address="Address", TelephoneHome="88005553225", TelephoneMobile="88005553225",
                TelephoneWork="88005553225",
